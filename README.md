...
**Skip CC Anki**, checked by default, leaves any note whose home deck is CC Anki out of the other side of the comparison: a large reference deck a lot of collections carry but never actually review, so a match there isn't real coverage. Unchecking it includes those notes like any other; the summary line says "(CC Anki skipped)" whenever the toggle is on.
