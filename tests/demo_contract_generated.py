...
REQUIRED_FIELDS = {'actions': {'activate': ['type', 'id'],
 ...
 'node': ['id',
          ...
          'style_roles',
          'actions'],
 'node_kinds': {'box': ['margins', 'gap', 'stretches', 'alignment'],
                ...
                'textarea': ['value',
                             ...
                             'max_length',
                             'max_blocks']},
 'request': ['protocol', 'epoch', 'sequence', 'render_revision', 'actions'],
 'response': ['protocol',
              'epoch',
              'sequence',
              'render_revision',
